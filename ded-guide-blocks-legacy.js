const initDedGuideBlocks = () => {
  ...
  const guides = {
    ...
    '/chto-nelzya-doveryat-neyroseti/': [
      { after: '01 ·', type: 'said', text: '«Нейросети я спокойно отдаю черновик, сравнение и список вопросов. Последнюю подпись под решением — нет. Особенно когда на кону деньги, здоровье или закон.»' },
      { after: '03 ·', type: 'did', title: 'Нейросеть выбрала клиенту лучший рекламный канал. Только продаж в таблице не было', html: '<p>Клиент прислал таблицу за месяц: расходы по рекламным каналам, количество заявок и стоимость заявки. Попросил быстро посмотреть, что оставить, а что отключить. Нейросеть посчитала показатели и уверенно назвала победителя — канал с самой дешёвой заявкой.</p><p><strong>Было:</strong> аккуратная таблица, правильная арифметика и очень убедительный вывод.</p><p><strong>Сделал:</strong> я посмотрел на исходные колонки и спросил клиента, где продажи и выручка. Их в таблице вообще не было. Добавили данные из CRM и пересчитали уже по деньгам, а не по заявкам.</p><p><strong>Стало:</strong> канал с самой дешёвой заявкой перестал быть лучшим. Он приводил много обращений, но заметно хуже превращал их в покупателей.</p><p><strong>Вывод:</strong> нейросеть умеет хорошо анализировать то, что вы ей дали. Но она не знает, каких важных данных вы забыли дать. Поэтому окончательное решение нельзя путать с красивым расчётом.</p>' }
    ],
    '/kartinki-neyrosetyu-otkrytki-avatarka/': [
      { after: '01 ·', type: 'said', text: '«Картинку нейросеть рисует за минуту. А одну букву в поздравлении может портить полвечера. Поэтому рисовать я ей доверяю охотно, а важную надпись всё равно проверяю сам.»' },
      { after: '03 ·', type: 'did', title: 'На 80-летие бабы Тани всё было хорошо — кроме надписи', html: '<p>В семье собирали поздравления бабе Тане на 80-летие, и я решил сделать к ним отдельную открытку. Попросил тёплую домашнюю сцену: стол, чайник, цветы, торт. Картинка получилась с первого раза вполне человеческая.</p><p><strong>Было:</strong> хорошая открытка и надпись «С юбилеем! 80 лет», в которой нейросеть умудрилась испортить буквы. Перегенерировал — исправила одну, испортила другую.</p><p><strong>Сделал:</strong> перестал воевать с генератором. Оставил в картинке свободное место, сохранил удачный вариант без текста и добавил поздравление обычным редактором.</p><p><strong>Стало:</strong> за несколько минут получили аккуратную открытку с нормальной надписью, которую не стыдно отправить в семейный чат.</p><p><strong>Вывод:</strong> нейросеть хорошо создаёт сцену и настроение. Там, где важна каждая буква, проще оставить финальный штрих человеку.</p>' }
    ],
    '/kak-razobratsya-s-dengami-tarify-kredity-kommunalka/': [
      { after: '01 ·', type: 'said', text: '«В деньгах нейросеть мне нужна не как советчик, а как бухгалтер с маркером: разложить цифры, найти странную строку и показать, что именно надо перепроверить.»' },
      { after: '03 ·', type: 'did', title: 'Толик был уверен, что оператор просто поднял тариф', html: '<p>Сосед Толик пожаловался, что связь стала заметно дороже. Он был уверен: оператор опять тихо поднял цену. В личном кабинете всё выглядело не очень понятно — тариф отдельно, услуги отдельно, списания ещё в одном месте.</p><p><strong>Было:</strong> несколько месяцев начислений и одна версия — «они просто повысили тариф».</p><p><strong>Сделал:</strong> выгрузили детализацию, убрали номер телефона и другие личные данные, а затем разложили с помощью нейросети повторяющиеся списания по группам. После этого каждую найденную услугу проверили уже в личном кабинете оператора.</p><p><strong>Стало:</strong> оказалось, что сам тариф почти не изменился. К нему тянулись два платных пакета, которыми Толик давно не пользовался. Их отключили через официальный кабинет.</p><p><strong>Вывод:</strong> нейросеть не должна решать, какой тариф вам нужен. Но она отлично помогает увидеть структуру расходов, когда глазами двадцать одинаковых строк уже не хочется сравнивать.</p>' }
    ],
    '/kak-nauchit-blizkogo-polzovatsya-neyrosetyu/': [
      { after: '01 ·', type: 'said', text: '«Самый плохой урок про нейросеть — сорок минут объяснять кнопки. Самый хороший — вместе решить одну задачу, которая человеку нужна сегодня.»' },
      { after: '03 ·', type: 'did', title: 'Оля говорила: «Мне проще тебя спросить»', html: '<p>Я несколько раз пытался показать Оле, что можно делать с нейросетью. Через пять минут она честно сказала: «Серёж, мне проще тебя спросить». На этом компьютерный кружок имени меня можно было закрывать.</p><p><strong>Было:</strong> мои объяснения про чаты, запросы и возможности — и ноль желания всё это запоминать.</p><p><strong>Сделал:</strong> через пару дней нам понадобилось выставить старый стол на продажу. Оля сфотографировала его на телефон, назвала размеры и состояние, а нейросеть помогла собрать из этого короткое объявление. Мы только убрали лишнюю рекламную бодрость и проверили факты.</p><p><strong>Стало:</strong> объявление разместили за несколько минут. А на следующий день Оля уже сама спросила не «как работает нейросеть», а «покажи, где тут ей голосом сказать».</p><p><strong>Вывод:</strong> близкого не надо учить ИИ вообще. Надо один раз показать пользу на его собственной задаче. Кнопки после этого почему-то запоминаются сами.</p>' }
    ]
  };
